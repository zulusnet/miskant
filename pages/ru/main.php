<div id="sub-header-table">
	<div id="sub-header">
		...
		<h2>Источник биомассы для OZE (Возобновляемые источники энергии)</h2>
		<p class="after-header">
			Вместе с вступлением Польши в Евросоюз и тем же введением обязанности
			производства части <strong>электрической энергии</strong> из <strong>возобновляемых
				источников</strong>, грандиозно увеличился интерес широко понятым
			ринком <strong>биомассы</strong>, особенно выращиванием видов
			растений, которых целый сбор возможно предназначить для
			энергетической цели.
		</p>
		<p class="second">
			Одном из самых перспективных растений, которую сегодня выращивается
			для <strong>получение энергии</strong>, является <strong>Мискантус
				гигантский</strong>.
		</p>
	</div>
	<!-- //#sub-header -->
		...
		<ul id="services">
			<li><img src="img/icons/info.png" alt="О НАС">
				...
				<p>
					...
					сегментов деятельности фирмы <strong>Andrzej Rogulski DORAN</strong>,
					которая была основана как ответ на увеличивающийся интерес <strong>зеленой
			...
			<li class="last-row-item"><img src="img/icons/plant.png"
				...
				<p>
					<strong>Мискантус гигантский первый раз был выращен в Дании </strong>
					в результате скрещения китайского Мискантуса (диплоидного вида) с
					сахарным (тетраплоидный). Мискантус гигантский это <strong>представительный
			...
			<li><img src="img/icons/special_offer2.png"
				...
				<h3>ПРЕДЛОЖЕНИЕ</h3>
				<p>
					Кроме <strong>корнеплодных саженцев</strong> Мискантуса
					гигантского, фирма Doran предлагает Вам комплектный консалтинг по
					основе и ведению плантаций Мискантуса Гигантского, услуги получения
