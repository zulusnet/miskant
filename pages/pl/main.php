<div id="sub-header-table">
	<div id="sub-header">
		...
		<h2>Źródło biomasy dla OZE</h2>
		<p class="after-header">
			Wraz z wejściem Polski do Unii Europejskiej oraz wprowadzeniem
			obowiązku wytwarzania części <strong>energii elektrycznej</strong> z
			<strong>odnawialnych źródeł</strong>, bardzo drastycznie wzrosło
			zainteresowanie szeroko rozumianym rynkiem<strong> biomasy</strong>,
			a w szczególności uprawą gatunków roślin, których plon w całości
			możnaby przeznaczyć na cele energetyczne.
		</p>
		<p class="second">
			Jedną z najbardziej perspektywicznych roślin, której uprawa
			przeznaczona jest dla <strong>pozyskania energii</strong> jest
			obecnie <strong>Miskant olbrzymi</strong>.
		</p>
	</div>
	<!-- //#sub-header -->
		...
		<ul id="services">
			<li><img src="<?php echo "$root_dir"?>/img/icons/info.png" alt="O Nas">
				...
				<p>
					...
					jednym z segmentów działalności firmy <strong>Andrzej Rogulski
						DORAN</strong>, która to została założona w odpowiedzi na rosnące
					zainteresowanie <strong>zieloną energią</strong> w Polsce i na
					świecie...
				</p>
				<p class="continue">
			...
			<li class="last-row-item"><img src="<?php echo "$root_dir"?>/img/icons/plant.png"
				...
				<p>
					...
					skrzyżowania miskanta chińskiego (diploidalnego gatunku) z
					miskantem cukrowym (tetraploidalny). Miskant olbrzymi jest <strong>okazałą
			...
			<li><img src="<?php echo "$root_dir"?>/img/icons/special_offer2.png" alt="Oferta">
				...
				<p>
					...
					firma Doran oferuje Państwu kompleksowe doradztwo w zakresie
					zakładania i prowadzenia plantacji Miskanta olbrzymiego, usługi
