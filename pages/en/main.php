<div id="sub-header-table">
	<div id="sub-header">
		...
		<h2>Source of biomass for renewable energy</h2>
		<p class="after-header">
			When Poland acceded to the European Union and introduction of the
			obligation of producing <strong>electricity from renewable sources</strong>
			was introduced, the interest in wide market of <strong>biomass</strong>
			increased dramatically, especially in cultivation of plant species,
			which yield could be spent in total for energy purposes.
		</p>
		<p class="second">
			One of most perspective plants, which cultivation is for <strong>energy
				purposes</strong> is <strong>presently Miscanthus</strong>.
		</p>
	</div>
	<!-- //#sub-header -->
		...
		<ul id="services">
			<li><img src="img/icons/info.png" alt="About Us">
				...
				<p>
					...
					segments of <strong>DORAN company</strong>, which was founded in
					response to the increasing interest in <strong>green energy</strong>
			...
			<li class="last-row-item"><img src="img/icons/plant.png"
				...
				<p>
					<strong>Miscanthus giganteus came into being in Denmark</strong> as
					a result of crossing Miscanthus sinensis (diploid species) and
					Miscanthus sacchariflorus (tetraploid). Miscanthus giganteus is an
			...
			<li><img src="img/icons/special_offer2.png"
				...
				<p>Apart from <strong>root cuttings</strong> of Miscanthus Giaganteus the company
					offers comprehensive advising on starting and running giant
